...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-magit nlinum-relative flycheck-ycmd company-anaconda anaconda-mode company-ycmd company ycmd flycheck counsel linum-relative git-timemachine git-gutter cmake-font-lock rtags anzu projectile-speedbar ppd-sr-speedbar sr-speedbar counsel-projectile projectile yasnippet-snippets yasnippet 0xc base16-default-dark neotree elscreen telephone-line 0blayout evil-collection hydra helm ## find-file-in-project smart-mode-line monokai-theme monokai-alt-theme evil-surround base16-theme))))
